...
//	Shader shaderSingleColor("shaderSourceCode/stencil_testing.vs", "shaderSourceCode/stencil_testing.fs");
//	
//	shader.use();
...
//		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT); // 用 clearcolor 填充 collor_buffer
//
//
